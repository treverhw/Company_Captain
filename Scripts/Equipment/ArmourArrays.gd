...
static var guardArmour = {#         name      Sp t  Sa We w  Si               desc
	"Flak" : 					["Flak Vest", 4, 3, 5, 2, 1, 1, "The best the 20th century has to offer."]
}

static var chaosArmour = {#         name          Sp t  Sa We w  Si               desc
	"Rags" : 					["Tattered Rags", 3, 3, 6, 1, 1, 1, "The worst the 20th century has to offer."]
}
